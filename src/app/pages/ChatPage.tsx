...
import { ArrowLeft, Search, Send, Lock, Clock } from 'lucide-react';
        ...
        <div className="space-y-2">
          {filteredConversations.length > 0 ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-sm text-gray-400 mt-2">Book a session to start chatting with barbers</p>
            </div>
          )}
        </div>
      </div>
